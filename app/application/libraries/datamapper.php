		...
		if ($this->valid)
		{
			...
			if (in_array($this->created_field, $this->fields) && empty($this->{$this->created_field}))
			{
				...
				if (in_array('captured_on', $this->fields) && empty($this->captured_on))
				{
					...
					date_default_timezone_set($s->value);
					$this->captured_on = strtotime(date($this->timestamp_format . ' +00:00'));
			...
			// HACK
			if (in_array('published_on', $this->fields) &&
					empty($this->published_on) &&
					(
